                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('home') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="birthplace" class="form-control @error('birthplace') is-invalid @enderror" required>
                                    <option value="" selected>Select the BirthPlace</option>
